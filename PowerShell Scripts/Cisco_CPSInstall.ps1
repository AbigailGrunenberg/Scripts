...
$URL="https://console.amp.cisco.com/install_packages/4e067a64-a6ea-43c6-b6de-951f752dbf92/download?product=WindowsProduct"
...
function Main {
    ...
    if (Empty? -list $list) {
        ...
        $Location=$User + "\Downloads\amp_CAPS-Prod-Block.exe"
