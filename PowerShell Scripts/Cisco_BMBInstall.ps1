...
$URL="https://console.amp.cisco.com/install_packages/b19a6197-ff38-41be-b33a-29e97f04a938/download?product=WindowsProduct"
...
function Main {
    ...
    if (Empty? -list $list) {
        ...
        $Location=$User + "\Downloads\amp_BIOC-Prod-Block.exe"
